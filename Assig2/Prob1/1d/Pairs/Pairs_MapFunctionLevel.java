...
public class Pairs_MapFunctionLevel {
    ...
    public static class PairMapper extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            // 🔥 Local aggregation map (per map call)
            ...
            for (int i = 0; i < tokens.length; i++) {
                ...
                for (int j = i + 1; j <= i + distance && j < tokens.length; j++) {
                    ...
                    localMap.put(keyPair, localMap.getOrDefault(keyPair, 0) + 1);
                }
            }

            // 🔥 Emit aggregated results for this map call
            for (String k : localMap.keySet()) {
                pair.set(k);
                context.write(pair, new IntWritable(localMap.get(k)));
            }
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(Pairs_MapFunctionLevel.class);
