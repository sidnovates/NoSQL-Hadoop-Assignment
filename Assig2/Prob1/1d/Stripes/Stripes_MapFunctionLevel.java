...
public class Stripes_MapFunctionLevel {
    ...
    public static class StripeMapper extends Mapper<Object, Text, Text, MapWritable> {
        ...
        public void map(Object key, Text value, Context context)
            ...
            //Local aggregation map (per line)
            HashMap<String, MapWritable> localMap = new HashMap<>();
            ...
            for (int i = 0; i < tokens.length; i++) {
                ...
                MapWritable stripe = localMap.getOrDefault(w1, new MapWritable());
                ...
                localMap.put(w1, stripe);
            }

            // Emit once per w1
            for (String w1 : localMap.keySet()) {
                context.write(new Text(w1), localMap.get(w1));
            }
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(Stripes_MapFunctionLevel.class);
