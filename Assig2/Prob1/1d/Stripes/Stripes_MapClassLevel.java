...
public class Stripes_MapClassLevel {
    ...
    public static class StripeMapper extends Mapper<Object, Text, Text, MapWritable> {
        ...
        private HashMap<String, MapWritable> globalMap;
        ...
        public void map(Object key, Text value, Context context)
            ...
            for (int i = 0; i < tokens.length; i++) {
                ...
                MapWritable stripe = globalMap.getOrDefault(w1, new MapWritable());
        ...
        protected void cleanup(Context context)
            ...
            for (String w1 : globalMap.keySet()) {
                context.write(new Text(w1), globalMap.get(w1));
            }
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(Stripes_MapClassLevel.class);
